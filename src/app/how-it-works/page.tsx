...
const steps = [
  {
    ...
    imagePlaceholder: "https://picsum.photos/seed/connect/500/350",
  ...
  },
  {
    ...
    imagePlaceholder: "https://picsum.photos/seed/configure/500/350",
  ...
  },
  {
    ...
    imagePlaceholder: "https://picsum.photos/seed/embed/500/350",
  ...
  },
  {
    ...
    imagePlaceholder: "https://picsum.photos/seed/design/500/350",
  ...
  },
  {
    ...
    imagePlaceholder: "https://picsum.photos/seed/fulfill/500/350",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="py-20 md:py-28 bg-gradient-to-b from-background via-primary/5 to-background text-center">
        ...
        <section className="py-16 md:py-24 bg-card">
          <div className="container max-w-5xl mx-auto px-4">
            <div className="relative">
              ...
              <div className="absolute top-0 h-full w-0.5 bg-border/40 left-1/2 -translate-x-1/2 hidden md:block" aria-hidden="true"></div>
                    ...
                    <div key={index} className="relative md:grid md:grid-cols-2 md:items-center md:gap-12">
                      ...
                      <div className={cn("relative mb-8 md:mb-0", isEven ? 'md:col-start-1' : 'md:col-start-2')}>
                        ...
                        <div className="relative z-10 p-4">
                          <h3 className="text-2xl md:text-3xl font-semibold font-headline text-foreground mb-4">{step.title}</h3>
                          <p className="text-muted-foreground leading-relaxed">{step.description}</p>
                        </div>
                      </div>

                      {/* Image Content */}
                      <div className={cn("relative", isEven ? 'md:col-start-2' : 'md:col-start-1 md:row-start-1')}>
                         <Image
                       ...
                       {/* Step Icon on the line (desktop only) */}
                       <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 hidden md:flex">
                         <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground ring-8 ring-card z-20">
