...
export function CasualLayout({ storeConfig, products, isLoading }: CasualLayoutProps) {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="w-full py-20 md:py-32 bg-muted/30 rounded-b-3xl">
      ...
      <section className="py-16 md:py-24 bg-muted/30 rounded-t-3xl">
        <div className="container mx-auto px-4">
          <div className="bg-card p-10 rounded-2xl shadow-lg flex flex-col md:flex-row items-center justify-between gap-8">
